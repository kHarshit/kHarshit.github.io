...
mathjax: true
excerpt: "How batch normalization speeds up training by normalizing hidden layer activations across the network using learnable scale and shift parameters."
---
