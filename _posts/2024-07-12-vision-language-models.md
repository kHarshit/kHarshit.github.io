...
{% include img.html src="/img/blog/vision-language-models/vlm_paradigms.jpg" width="70%" caption="Vision Language Models training paradigms" %}
...
{% include img.html src="/img/blog/vision-language-models/clip.jpg" width="60%" caption="CLIP architecture (source: CLIP paper)" %}
...
{% include img.html src="/img/blog/vision-language-models/clip_zero_shot.jpg" width="70%" caption="CLIP Zero-Shot Classifier(source: CLIP paper)" %}
...
{% include img.html src="/img/blog/vision-language-models/flava.jpg" caption="FLAVA (source: FLAVA paper)" %}
...
{% include img.html src="/img/blog/vision-language-models/flava_architecture.jpg" width="70%" caption="FLAVA architecture (source: FLAVA paper)" %}
...
{% include img.html src="/img/blog/vision-language-models/coca.jpg" width="70%" caption="CoCa (source: CoCa paper)" %}
...
{% include img.html src="/img/blog/vision-language-models/coca_tasks.jpg" width="70%" caption="CoCa architecture (source: CoCa paper)" %}
...
{% include img.html src="/img/blog/vision-language-models/chameleon.jpg" width="60%" caption="Chameleon architecture (source: Chameleon paper)" %}
...
{% include img.html src="/img/blog/vision-language-models/frozen.jpg" caption="Frozen architecture (source: Frozen paper)" %}
...
{% include img.html src="/img/blog/vision-language-models/frozen_zero_shot.jpg" width="70%" caption="Frozen downstream tasks (source: Frozen paper)" %}
...
{% include img.html src="/img/blog/vision-language-models/llava.jpg" width="70%" caption="LLaVA architecture (source: LLaVA paper)" %}
...
{% include img.html src="/img/blog/vision-language-models/llava_instruction_tuning.jpg" width="70%" caption="LLaVA instruction tuning (source: LLaVA paper)" %}
...
{% include img.html src="/img/blog/vision-language-models/llava15.jpg" width="70%" caption="LLaVA 1.5 (source: LLaVA paper)" %}
...
{% include img.html src="/img/blog/vision-language-models/frozen_llms.jpg" width="60%" caption="Method of using a frozen transformer block from pre-trained LLMs as a visual encoder layer (source: Frozen transformers in Language Models paper)" %}
